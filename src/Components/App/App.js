    ...
    return (
      <Router>
        <div>
          ...
          <Routes>
            <Route path="/" element = {<Choose teams ={choose} teamSelectedText ={selectedTeamLong} team={selectedTeam}/>} ></Route>

            <Route path="/options"
              element={<Options boards={boards} team={selectedTeam} rounds={rounds} />}
            />
            <Route
                path="/simulator"
              element={
